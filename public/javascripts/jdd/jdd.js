...
var jdd = {
    ...
    processDiffs: function () {
        ...
        jdd.diffs.forEach(function (diff) {
            ...
            if (left.indexOf(diff.path1.line) === -1) {
                leftLineLookup[diff.path1.line].addEventListener(
                    "click",
                    function () {
            ...
            if (right.indexOf(diff.path2.line) === -1) {
                rightLineLookup[diff.path2.line].addEventListener(
                    "click",
                    function () {
    ...
    setupNewDiff: function () {
        ...
        document
            .querySelectorAll(".diffcontainer pre")
    ...
    compare: function () {
        ...
        window.addEventListener("scroll", function () {
            if (
                ...
                document.getElementById("toolbar").style.top = "80px";
            } else {
